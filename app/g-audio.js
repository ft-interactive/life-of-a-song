...
function shouldDispatch(progress) {
  const relevantProgressPoints = [
    8, 9, 10, 11, 12, 23, 24, 25, 26, 27, 48, 49, 50, 51, 52, 73, 74, 75, 76, 77, 100,
  ];
...
function fireEvent(action, audioObject, extraDetail = {}) {
  ...
  const playButtonElement =
    audioObject.targetObject.getElementsByClassName('g-audio--playbutton')[0];
...
class AudioPlayer {
  ...
  loadMetadata() {
    ...
    this.targetObject.getElementsByClassName('g-audio--playbutton')[0].addEventListener(
      'keypress',
      (e) => {
